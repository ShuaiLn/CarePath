...
import { CLARIFICATION_REASONS, FIELD_IDS, SCOPE_FLAG_IDS } from './types'
 ...
 *
 *   1. EXTRACTION_JSON_SCHEMA — the structured-output JSON Schema passed as
 *      Ollama's `format` field (every property required,
 *      additionalProperties:false everywhere, "optional" fields represented
 *      as nullable) — the closest structural analog to what used to be
 *      OpenAI's Structured Outputs `json_schema`.
...
// ---- Ollama structured-output JSON Schema ("format" field) ----------------
